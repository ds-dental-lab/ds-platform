...
//
// ★ 이름은 우리가 지은 것입니다 — `ORD-260811-013_스캔1.obj`.
//   원본에는 환자 이름이 들어 있어 저장할 때 버립니다
//   (domain/file-name). 그래서 여기 보이는 이름과 내려받는 이름이 같습니다.
//
// ★ 긴 이름은 가운데를 접습니다.
//   지은 이름은 짧아 웬만해선 안 접히지만, 창을 줄이면 접힙니다.
//   끝을 자르면 주문번호만 남고 몇 번째 파일인지가 사라집니다 —
//   앞뒤를 남기고 가운데를 `…` 로 접어야 갈라 볼 수 있습니다.
//
// ★ 안 올라간 파일도 보여 줍니다.
