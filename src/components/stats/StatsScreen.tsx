    ...
    <div className="space-y-3.5">
          ...
          <div className="ml-auto flex gap-1.5">
            {months.map((m) => (
              <Link
                ...
                className={
                  'h-8 rounded-md border px-3 text-[13.5px] font-semibold leading-8 ' +
                  (m.value === month
      ...
      <section className="rounded-lg border border-[#E8EBF0] bg-white">
        <header className="flex items-baseline gap-2 border-b border-[#E8EBF0] px-5 py-3.5">
          ...
          <span className="text-[13px] text-[#98A2B3]">{stats.designers.length}명</span>
        </header>
      ...
      <section className="rounded-lg border border-[#E8EBF0] bg-white">
        <header className="flex items-baseline gap-2 border-b border-[#E8EBF0] px-5 py-3.5">
          ...
          <span className="text-[13px] text-[#98A2B3]">{stats.clinics.length}곳</span>
        </header>
      ...
      <section className="rounded-lg border border-dashed border-[#DDE2EA] bg-[#FBFCFD] px-5 py-4">
        <h2 className="text-[14px] font-bold tracking-tight text-[#4A5567]">
          아직 못 넣은 것
        </h2>
        <ul className="mt-2 space-y-1 text-[13px] leading-relaxed text-[#98A2B3]">
...
function Stat({ label, value, warn }: { label: string; value: string; warn?: boolean }) {
  return (
    <div className="rounded-md border border-[#E8EBF0] px-3 py-2.5">
      <p className="text-[12.5px] text-[#98A2B3]">{label}</p>
