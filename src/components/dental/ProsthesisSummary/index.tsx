    ...
    <div className="rounded-lg border border-gray-200 bg-white">
      <div className="flex items-center justify-between border-b border-gray-200 px-5 py-3">
        ...
        <button
          ...
          className={
            highlight
              ? 'rounded border border-red-500 px-3 py-1.5 text-[13px] font-semibold text-red-600 hover:bg-red-50'
              : 'cursor-not-allowed rounded border border-gray-200 px-3 py-1.5 text-[13px] text-gray-300'
          }
        >
          초기화
        </button>
