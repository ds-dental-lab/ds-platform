...
//
// ★ 순서(①쉐이드가이드 ②정면 ③자유컷)는 **권장이지 강제가 아닙니다.**
        ...
        {!fallback && (
          <>
            {/*
              ...
              ★ 글자색은 **티일** 그대로입니다. 흰 글자에 테두리까지
                둘렀더니 이 화면에서 저 혼자 튀었습니다 — 눈에 띄는
                것과 어울리는 것은 다릅니다. 이 카메라의 티일은
                컷 딱지·가이드선·셔터까지 이미 한 벌입니다.

              ★ 대신 **크기로** 띄웁니다(12.5 → 15px). 색을 바꾸지
                않고도 읽히게 하는 방법이 그것입니다.

              ★ 가운데 알약 — 폭을 글자에 맞춥니다. 화면 전체를
                가로지르면 그만큼 환자가 덜 보입니다.
            */}
            <p className="absolute inset-x-0 top-3 flex justify-center">
              <span className="rounded-xl bg-black/55 px-3.5 py-2 text-[15px] font-bold tracking-[-0.2px] text-[#2DD4BF]">
