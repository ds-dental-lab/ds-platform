...
export const CONSENT = {
  ...
  /*
    ★ 폼에는 **한 줄**만 띄웁니다 (사용자 요청 2026-09-04). 세 줄짜리
      고지문은 아무도 안 읽고, 폼만 무거워 보입니다. 항목·목적·파기는
      처리방침에 다 있고 그 링크를 바로 옆에 둡니다.
    ★ 위 세 값과 같은 뜻이어야 합니다 — 여기서 다른 말을 하면 화면과
      처리방침이 갈립니다.
  */
  line: '수가표 발송과 상담 연락을 위해 연락처·이메일을 씁니다',
};
